          ...
          {updates.map(update => (
            <div key={update.id} className="glass-panel p-4 rounded-2xl border border-[var(--border-color)] flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full py-2.5 bg-[var(--accent)] text-[var(--text-on-accent)] rounded-xl font-black text-xs uppercase tracking-widest hover:brightness-110 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
