...
const tools: FunctionDeclaration[] = [
  ...
  {
    name: "manage_thought",
    description: "Управляет идеями и заметками. МОЖЕТ СОЗДАВАТЬ РАЗНЫЕ СЕКЦИИ ВНУТРИ ОДНОЙ ИДЕИ.",
    parameters: {
      type: Type.OBJECT,
      properties: {
...
7. **ПРАВИЛА РЕДАКТИРОВАНИЯ И ПОИСКА МЫСЛЕЙ (КРИТИЧНО ВАЖНО)**:
...
8. **РАБОТА С СЕКЦИЯМИ (МНОГОЗАДАЧНОСТЬ)**:
