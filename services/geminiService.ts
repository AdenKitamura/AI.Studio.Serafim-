...
export const polishText = async (text: string): Promise<string> => {
    ...
    try {
        const response = await ai.models.generateContent({
            ...
            contents: `
                Ты редактор текста.
                Твоя задача: Исправить пунктуацию, орфографию, расставить заглавные буквы и убрать слова-паразиты (типа "эээ", "ну").
                Сделай текст читаемым и естественным, но НЕ меняй смысл.
